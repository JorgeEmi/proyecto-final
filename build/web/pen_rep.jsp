<%-- 
    Document   : pen_rep
    Created on : 3 abr. 2023, 22:41:09
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <h2 class="py-10"><center><b>Pagina del Ingeniero</b></center></h2>



        <h2><center><br>Reportes Pendientes en Soporte  </br></br></center></h2>
                                                    ...
                                                    <% //Conexión a la bdd
                                                        ...
                                                        try {
                                                            ...
                                                            String SQLQuery = "SELECT id_case_admin,admin_id,case_id,case_name,case_desc,case_status,case_creation_date,case_solution FROM tbl_case_admin "
                                                                    + "INNER JOIN tbl_cases ON tbl_case_admin.case_id = tbl_cases.id_case where case_area='Soporte' and not case_status='Cerrado';";
                                                                        ...
                                                                        <tbody class="divide-y divide-gray-200 bg-white">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                                                    <a href="eng_supp.jsp?case_id=<%=id_case%>">Editar</a>  
                                                                                </td>
                                                                            </tr>                
                                                                            <%
                                                                                    }
