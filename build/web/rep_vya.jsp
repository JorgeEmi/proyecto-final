        ...
        <div class="min-h-full">
            ...
            <main>
                 <%
                    ...
                    //Query
                    PreparedStatement pst = conexion.prepareStatement("SELECT id_case, case_name, usr_id, case_area, case_status, case_creation_date, case_last_update_date, case_desc, case_solution FROM tbl_cases where id_case=?");
                    //Posición del id
                    pst.setString(1, ids);
                    ...
                    String case_solution = resultado.getString(9);
                    if (case_solution == null) {
                        case_solution = "Sin solución todavía";
                        }
                                                        ...
                                                        <div class="overflow-hidden bg-white shadow sm:rounded-lg max-w-5xl">
                                                            ...
                                                            <div class="border-t border-gray-200">
                                                                <dl>
                                                                    ...
                                                                    <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                                                                        <dt class="text-sm font-medium text-gray-500">Solución del reporte</dt>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            ...
                                                            <button type="button" name="area" value="Soporte" >
                                                                <a href="rep_eng.jsp?id_case=<%= ids%>" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Ingeniero de Soporte</a>
                                                            </button>
                                                            <button type="button" name="area" value="Mantenimiento">
                                                                <a href="rep_man.jsp?id_case=<%= ids%>" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Gerente de Mantenimiento</a>
                                                            </button>
                                                            
                                                        </div><br><br><br><br>
                                                         <div>
                                                                <button type="button" value="Regresar">
                                                                <a href="indexgs.jsp" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Regresar</a>
                                                                </button>  
                                                        </div>
