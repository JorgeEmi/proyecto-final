<%-- 
    Document   : pen_rep_main
    Created on : 3 abr. 2023, 23:44:15
    Author     : User
--%>
...
<html>
    ...
    <body>
        ...
        <h2 class="py-4"><center><b>Pagina del Ingeniero</b></center></h2>



        <h2><center><br>Reportes Pendientes en Mantenimiento</br></br></center></h2>
                                                    ...
                                                    <% //Conexión a la bdd
                                                        ...
                                                        try {
                                                            ...
                                                            String SQLQuery = "SELECT id_case_admin,admin_id,case_id,case_name,case_desc,case_status,case_creation_date,case_solution FROM tbl_case_admin "
                                                                    + "INNER JOIN tbl_cases ON tbl_case_admin.case_id = tbl_cases.id_case  where case_area='Mantenimiento' and not case_status='Cerrado';";
