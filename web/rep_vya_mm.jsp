                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="py-10">
                                                                <button type="button" value="Regresar">
                                                                    <a href="indexmm.jsp" class="rounded-md bg-stone-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-stone-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-stone-600">Regresar</a>
                                                                </button>  
                                                            </div>
