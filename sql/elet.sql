...
insert into tbl_users (user_name, user_pwd, is_admin) values ("g_soporte", "root", 1);
insert into tbl_users (user_name, user_pwd, is_admin) values ("g_mto", "root", 1);
insert into tbl_users (user_name, user_pwd, is_admin) values ("asis", "root", 1);
insert into tbl_users (user_name, user_pwd, is_admin) values ("ing_soporte", "root", 1);
insert into tbl_users (user_name, user_pwd, is_admin) values ("ing_mto", "root", 0);
insert into tbl_users (user_name, user_pwd, is_admin) values ("editor", "root", 0);
insert into tbl_users (user_name, user_pwd, is_admin) values ("rodri", "tilinesio", 0);
insert into tbl_users (user_name, user_pwd, is_admin) values ("valencia", "tilinesio", 0);
insert into tbl_users (user_name, user_pwd, is_admin) values ("aranzuki", "tilinesio", 0);
